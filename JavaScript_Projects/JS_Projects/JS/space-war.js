...
window.addEventListener("keydown", function (e) {
  if (e.keyCode == "32") {
    ...
    img.src =
      "https://github.com/Abhisek730/space-war-game/blob/main/fire.png?raw=true";
    ...
    setInterval(function collision() {
      var canonLeft = parseInt(
        window.getComputedStyle(canon).getPropertyValue("left")
      );
      var canonTop = parseInt(
        window.getComputedStyle(canon).getPropertyValue("top")
      );
